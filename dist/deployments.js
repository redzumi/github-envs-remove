...
var Deployments = (function () {
    function Deployments() {
        var _this = this;
        this.fetchFromAPI = function () { return __awaiter(_this, void 0, void 0, function () {
            var deploymentsData, deployments;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, api_1.default.request(URL)];
                    case 1:
                        deploymentsData = _a.sent();
                        deployments = deploymentsData.map(function (data) { return new deployment_1.default(data); });
                        this.deployments = deployments;
                        return [2, this.deployments];
                }
            });
        }); };
    }
